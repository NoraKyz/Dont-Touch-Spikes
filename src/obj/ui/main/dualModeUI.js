...
export class DualModeUI extends MainUI {
  ...
  _createGameTutoriral(id, positionPlayer, positionTutorial, direction, color) {
    ...
    gameTutorial.player = new Text(`PLAYER ${id}`, {
      ...this.styleBig,
      fill: color,
    });
    ...
    gameTutorial.tutor = new Text("touch here to jump", {
      ...this.styleSmall,
      fill: color,
    });
  ...
  _onPlayer1Win() {
    if (this.bottomStar1.winStar.visible === false)
      this.bottomStar1.winStar.visible = true;
    else if (this.bottomStar2.winStar.visible === false)
      this.bottomStar2.winStar.visible = true;
    else if (this.bottomStar3.winStar.visible === false)
      this.bottomStar3.winStar.visible = true;
    this.gameState.player1 = [
      this.bottomStar1.winStar.visible,
      this.bottomStar2.winStar.visible,
      this.bottomStar3.winStar.visible,
    ];
  }
  _onPlayer2Win() {
    if (this.topStar1.winStar.visible === false)
      this.topStar1.winStar.visible = true;
    else if (this.topStar2.winStar.visible === false)
      this.topStar2.winStar.visible = true;
    else if (this.topStar3.winStar.visible === false)
      this.topStar3.winStar.visible = true;
    this.gameState.player2 = [
      this.topStar1.winStar.visible,
      this.topStar2.winStar.visible,
      this.topStar3.winStar.visible,
    ];
  }
  _onDraw() {
    if (this.topStar3.winStar.visible === true)
      this.topStar3.winStar.visible = false;
    else if (this.topStar2.winStar.visible === true)
      this.topStar2.winStar.visible = false;
    else if (this.topStar1.winStar.visible === true)
  ...
  _initEffect() {
    this.elapsed = 0;
    this.tween1 = new TWEEN.Tween(this.gameTutorial).to({ alpha: 0 }, 1000);
    this.tween2 = new TWEEN.Tween(this.gameTutorial).to({ alpha: 1 }, 1000);
    this.tweenResult = new TWEEN.Tween(this.resultUI).to({ alpha: 1 }, 1000);
  }
